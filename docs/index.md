...
!!! info
    ...
    **Source Code Repository:** [https://github.com/ai-rolling-demo/my](https://github.com/ai-rolling-demo/my)

    **GitOps Repository:** [https://github.com/ai-rolling-demo/my-gitops](https://github.com/ai-rolling-demo/my-gitops)

# **Usage**

To access the joey application that was deployed using the Software Template, complete the following instructions:
